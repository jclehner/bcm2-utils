...
uint32_t writecode[] = {
		...
		_WORD(0), // 0x04: buffer
		_WORD(0), // 0x08: index
		_WORD(0), // 0x0c: chunk size
		_WORD(0), // 0x10: partition offset
		_WORD(0), // 0x14: partition size
		_WORD(0), // 0x18: printf
		_WORD(0), // 0x1c: scanf / sscanf
		_WORD(0), // 0x20: getline
		_WORD(0), // 0x24: flash write
		_WORD(0), // 0x28: flash erase
		_WORD(0), // 0x2c: length
		// main:
...
uint32_t dumpcode2[] = {
  ...
  0xD0FFBD27, 0x2C00BFAF, 0x2800B5AF, 0x2400B4AF, 
  0x2000B3AF, 0x1C00B2AF, 0x1800B1AF, 0x1400B0AF, 
  0x01001104, 0xFFFF123C, 0x2490F203, 0x1C00428E, 
  0x3B004050, 0x2C00BF8F, 0x2800438E, 0x20006010, 
  0x1400458E, 0x0C00428E, 0x02004230, 0x3C004010, 
  0x1800448E, 0x30005026, 0x50005326, 0x25100002, 
  0xFCFF438C, 0x08006050, 0x2800428E, 0x0000478C, 
  0x08004224, 0x0000668C, 0x000067AC, 0xF8FF6216, 
  0xF8FF46AC, 0x2800428E, 0x09F84000, 0x1C00468E, 
  0xFCFF028E, 0x08004050, 0x1400458E, 0x0000048E, 
  0x08001026, 0x0000438C, 0x000044AC, 0xF8FF7016, 
  0xF8FF03AE, 0x1400458E, 0x1C00428E, 0x280040AE, 
  0x2000438E, 0x04005326, 0x08005526, 0x1000B124, 
  0x2BA04300, 0x0B185400, 0x23104300, 0x25A06000, 
  0x1C0042AE, 0xF0FF3026, 0x2400428E, 0x04001026, 
  0x25206002, 0x09F84000, 0xFCFF058E, 0xFBFF1116, 
  0x2400428E, 0xFFFF9426, 0x2520A002, 0x09F84000, 
  0x10003126, 0xF4FF8016, 0xF0FF3026, 0x2C00BF8F, 
  0x2800B58F, 0x2400B48F, 0x2000B38F, 0x1C00B28F, 
  0x1800B18F, 0x1400B08F, 0x0800E003, 0x3000BD27, 
  0x25108000, 0x2520A000, 0xC2FF0010, 0x25284000,
