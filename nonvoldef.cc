	...
	virtual list definition(int type, const nv_version& ver) const override
	{
		...
		if (profile() && profile()->cfg_flags() & BCM2_CFG_DATA_USERIF_ALT) {
			return {
				...
				NV_VAR(nv_p16string, "unk_user1", 16),
				NV_VAR(nv_p16string, "unk_pass1", 16),
				NV_VAR(nv_p16string, "unk_pass2"),
				NV_VAR(nv_p16string, "unk_user2"),
				NV_VAR(nv_p16string, "unk_pass3"),
