	...
	virtual list definition(int type, const nv_version& ver) const override
	{
		...
		if (type != fmt_perm) {
			return {
				...
				NV_VAR(nv_p8string, "wps_model"),
				NV_VAR(nv_p8string, "wps_manufacturer"),
				NV_VAR(nv_p8string, "wps_device_name"),
				// ?? nv_bool wps_external ??
				NV_VAR(nv_u8, "", true),
				NV_VAR(nv_p8string, "wps_sta_pin"),
				NV_VAR(nv_p8string, "wps_model_num"),
